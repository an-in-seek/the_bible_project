...
const ROUTES = [
    {id: "route-exodus-south", routeGroupId: "exodus", viewpoint: "남부 경로 (전통)", name: "출애굽 경로",
        ...
        desc: "라암셋에서 홍해를 건너 시내 반도 남부의 시내산(전통)을 거쳐 가데스 바네아로 향하는 전통적 견해입니다. 세부 경유지는 단순화된 근사입니다.",
        coords: [[31.83, 30.80], [32.55, 30.20], [32.90, 29.55], [33.20, 28.90], [33.97, 28.54], [34.20, 29.60], [34.42, 30.65], [35.10, 30.95], [35.63, 31.45], [35.44, 31.87]],
    ...
    {id: "route-exodus-north", routeGroupId: "exodus", viewpoint: "북부 경로설", name: "출애굽 경로",
        ...
        coords: [[31.83, 30.80], [32.60, 30.75], [33.40, 30.85], [34.00, 30.60], [34.42, 30.65], [35.10, 30.95], [35.63, 31.45], [35.44, 31.87]],
