...
const PERIODS = [
    ...
    {id: "exile", name: "바벨론 포로기", from: -605, to: -538, mvp: true,
        desc: "BC 605·597·586년 세 차례의 포로 이주로 진행되어 539/538년 페르시아의 귀환 허용까지 이어집니다."},
    ...
    {id: "roman", name: "로마 시대", from: -63, to: 100, mvp: true,
        desc: "로마의 유대 지배와 헤롯 왕조, 예수님의 사역, 유대 전쟁과 AD 70년 성전 파괴를 포함합니다."},
...
const SNAPSHOTS = [
    ...
    {id: "s-exodus", periodId: "exodus", baseYear: -1270, certainty: "DISPUTED",
        label: "출애굽·광야 여정 (BC 1270년경, 연대 견해 상이)"},
    ...
    {id: "s-rome-pompey", periodId: "roman", baseYear: -60, from: -63, to: -38,
        certainty: "APPROXIMATE", label: "폼페이우스 이후 로마 영향권의 유대 (BC 63~38년)"},
    {id: "s-rome-herod", periodId: "roman", baseYear: -4, from: -37, to: 5,
        certainty: "APPROXIMATE", label: "헤롯 왕국과 초기 분봉왕 시대 (BC 37~AD 5년)"},
    {id: "s-rome-herod", periodId: "roman", baseYear: -20, from: -63, to: 5,
        certainty: "APPROXIMATE", label: "로마 세력권의 유대와 헤롯 왕국 (BC 63~AD 5년)"},
    {id: "s-rome-nt", periodId: "roman", baseYear: 30, from: 6, to: 39,
        certainty: "APPROXIMATE", label: "로마 유대 속주와 갈릴리 분봉왕국 (AD 6~39년)"},
    {id: "s-rome-agrippa", periodId: "apostolic", baseYear: 42, from: 40, to: 44,
        certainty: "APPROXIMATE", label: "헤롯 아그립바 1세의 왕국 (AD 40~44년)"},
    {id: "s-apostolic", periodId: "apostolic", baseYear: 35, from: 30, to: 39,
        certainty: "APPROXIMATE", label: "예루살렘 교회와 초기 복음 확산 (AD 30~39년)"},
    {id: "s-apostolic-missions", periodId: "apostolic", baseYear: 60, from: 45, to: 69,
        certainty: "APPROXIMATE", label: "바울 선교와 지중해 교회 확산 (AD 45~69년)"},
    {id: "s-apostolic-late", periodId: "apostolic", baseYear: 85, from: 70, to: 100,
        certainty: "APPROXIMATE", label: "후기 사도 시대의 지중해 세계 (AD 70~100년)"}
];
...
const PLACES = [
    ...
    {id: "bethany", name: "베다니", en: "Bethany", modern: "팔레스타인 알에이자리야(유력)", type: "마을",
        lngLat: [35.26, 31.77], from: -63, to: 100, importance: 3, certainty: "PROBABLE",
        desc: "마르다·마리아·나사로가 살았고 예수님이 예루살렘 방문 때 머무르신 마을입니다.",
        refs: [{label: "요한복음 11장", bookOrder: 43, chapter: 11}, {label: "마가복음 11장", bookOrder: 41, chapter: 11}]},
    {id: "cana", name: "가나", en: "Cana", modern: "갈릴리 카프르 칸나·키르벳 카나 등 논쟁", type: "마을",
        lngLat: [35.34, 32.75], from: -63, to: 100, importance: 3, certainty: "DISPUTED",
        desc: "예수님이 혼인 잔치에서 물을 포도주로 바꾸신 곳으로, 정확한 위치에는 여러 견해가 있습니다.",
        refs: [{label: "요한복음 2장", bookOrder: 43, chapter: 2}]},
    {id: "magdala", name: "막달라", en: "Magdala", modern: "이스라엘 미그달", type: "마을",
        lngLat: [35.52, 32.82], from: -63, to: 100, importance: 3, certainty: "CONFIRMED",
        desc: "갈릴리 호숫가의 어업 도시로, 막달라 마리아의 출신지와 연결됩니다.",
        refs: [{label: "누가복음 8장", bookOrder: 42, chapter: 8}]},
    {id: "tiberias", name: "디베랴", en: "Tiberias", modern: "이스라엘 티베리아스", type: "도시",
        lngLat: [35.53, 32.79], from: 20, to: 100, importance: 3, certainty: "CONFIRMED",
        desc: "헤롯 안티파스가 세운 갈릴리의 행정 중심지로, 갈릴리 호수의 다른 이름에도 남아 있습니다.",
        refs: [{label: "요한복음 6장", bookOrder: 43, chapter: 6}]},
    ...
    {id: "gaza", name: "가사", en: "Gaza", modern: "팔레스타인 가자", type: "도시",
        lngLat: [34.46, 31.50], from: -2000, to: 100, importance: 3, certainty: "CONFIRMED",
        desc: "블레셋 다섯 성읍 중 하나로 삼손 이야기의 무대이며, 빌립이 에디오피아 내시에게 복음을 전한 길목입니다.",
        refs: [{label: "사사기 16장", bookOrder: 7, chapter: 16}, {label: "사도행전 8장", bookOrder: 44, chapter: 8}]},
    ...
    {id: "mizpah", name: "미스바", en: "Mizpah", modern: "텔 엔나스베(유력)", type: "마을",
        lngLat: [35.22, 31.89], from: -1100, to: -400, importance: 3, certainty: "PROBABLE",
        desc: "사무엘이 이스라엘을 모아 기도한 곳이며, 예루살렘 함락 후에는 바벨론이 세운 총독 그달리야의 행정 중심지였습니다.",
        refs: [{label: "사무엘상 7장", bookOrder: 9, chapter: 7}, {label: "열왕기하 25장", bookOrder: 12, chapter: 25}]},
    {id: "riblah", name: "립나 (하맛 땅)", en: "Riblah", modern: "시리아 리블레", type: "마을",
        lngLat: [36.55, 34.46], from: -700, to: -500, importance: 3, certainty: "PROBABLE",
        desc: "오론테스 강가의 바벨론군 사령부로, 사로잡힌 시드기야가 느부갓네살에게 심문받은 곳입니다.",
        refs: [{label: "열왕기하 25장", bookOrder: 12, chapter: 25}, {label: "예레미야 39장", bookOrder: 24, chapter: 39}]},
    {id: "tel-abib", name: "델아빕 (그발 강가)", en: "Tel-abib", modern: "이라크 닙푸르 인근 운하 지대(추정)", type: "마을",
        lngLat: [45.23, 32.13], from: -597, to: -400, importance: 2, certainty: "APPROXIMATE",
        desc: "그발 강가의 유다 포로 정착촌으로, 에스겔이 이상을 보고 사역한 곳입니다. 그발 강은 닙푸르 부근의 대운하로 봅니다.",
        refs: [{label: "에스겔 1장", bookOrder: 26, chapter: 1}, {label: "에스겔 3장", bookOrder: 26, chapter: 3}]},
    {id: "tahpanhes", name: "다바네스", en: "Tahpanhes", modern: "이집트 텔 데펜네(유력)", type: "도시",
        lngLat: [32.17, 30.86], from: -700, to: -400, importance: 3, certainty: "PROBABLE",
        desc: "나일 삼각주 동편의 국경 도시로, 그달리야 피살 후 유다 피난민이 예레미야와 함께 내려간 곳입니다.",
        refs: [{label: "예레미야 43장", bookOrder: 24, chapter: 43}]},
    ...
    {id: "pi-hahiroth", name: "비하히롯 (홍해 도하 추정지)", en: "Pi-hahiroth", modern: "수에즈 만 북단·쓴물 호수 일대(추정)", type: "광야",
        lngLat: [32.55, 29.95], from: -1600, to: -1200, importance: 3, certainty: "DISPUTED",
        desc: "바알스본 맞은편 바닷가 진영지로, 홍해 도하 지점은 쓴물 호수·수에즈 만·아카바 만 등 견해가 갈립니다.",
        refs: [{label: "출애굽기 14장", bookOrder: 2, chapter: 14}]},
    {id: "marah", name: "마라", en: "Marah", modern: "아인 하와라(추정)", type: "광야",
        lngLat: [33.00, 29.25], from: -1600, to: -1200, importance: 3, certainty: "DISPUTED",
        desc: "수르 광야 사흘 길 끝의 진영지로, 쓴 물이 나무를 던지자 달게 된 곳입니다.",
        refs: [{label: "출애굽기 15장", bookOrder: 2, chapter: 15}]},
    {id: "elim", name: "엘림", en: "Elim", modern: "와디 가란델(추정)", type: "광야",
        lngLat: [33.10, 29.13], from: -1600, to: -1200, importance: 3, certainty: "DISPUTED",
        desc: "물샘 열둘과 종려 칠십 주가 있던 광야 여정의 진영지입니다.",
        refs: [{label: "출애굽기 15장", bookOrder: 2, chapter: 15}]},
    {id: "ezion-geber", name: "에시온게벨", en: "Ezion-geber", modern: "요르단 아카바 인근 텔 엘켈레이페(유력)", type: "항구",
        lngLat: [34.98, 29.55], from: -1300, to: -500, importance: 3, certainty: "PROBABLE",
        desc: "아카바 만 북단의 진영지로, 에돔 우회 때 지나갔고 훗날 솔로몬이 배들을 지은 항구입니다.",
        refs: [{label: "민수기 33장", bookOrder: 4, chapter: 33}, {label: "열왕기상 9장", bookOrder: 11, chapter: 9}]},
    {id: "hor", name: "호르 산", en: "Mount Hor", modern: "페트라 인근 예벨 하룬(전통)", type: "산",
        lngLat: [35.41, 30.32], from: -1600, to: -1200, importance: 3, certainty: "DISPUTED",
        desc: "에돔 땅 변경에서 아론이 죽어 장사된 산으로, 전통적으로 페트라 부근 예벨 하룬과 연결합니다.",
        refs: [{label: "민수기 20장", bookOrder: 4, chapter: 20}]},
    {id: "heshbon", name: "헤스본", en: "Heshbon", modern: "요르단 텔 헤스반", type: "도시",
        lngLat: [35.81, 31.80], from: -1600, to: -586, importance: 3, certainty: "PROBABLE",
        desc: "아모리 왕 시혼의 도성으로, 이스라엘이 요단 동편에서 첫 승리를 거둔 곳입니다.",
        refs: [{label: "민수기 21장", bookOrder: 4, chapter: 21}]},
    ...
    {id: "seleucia-pieria", name: "실루기아", en: "Seleucia Pieria", modern: "터키 사만다으 인근", type: "항구",
        lngLat: [35.84, 36.12], from: -300, to: 100, importance: 3, certainty: "CONFIRMED",
        desc: "수리아 안디옥의 외항으로, 바울과 바나바가 1차 전도여행을 시작하며 배를 탄 곳입니다.",
    ...
    {id: "perga", name: "버가", en: "Perga", modern: "터키 안탈리아 악수 인근", type: "도시",
        lngLat: [30.85, 36.96], from: -300, to: 100, importance: 3, certainty: "CONFIRMED",
        desc: "바울 일행이 구브로에서 소아시아로 건너와 도착했고, 귀환길에 다시 복음을 전한 밤빌리아의 도시입니다.",
        refs: [{label: "사도행전 13장", bookOrder: 44, chapter: 13}, {label: "사도행전 14장", bookOrder: 44, chapter: 14}]},
    {id: "attalia", name: "앗달리아", en: "Attalia", modern: "터키 안탈리아", type: "항구",
        lngLat: [30.70, 36.89], from: -300, to: 100, importance: 3, certainty: "CONFIRMED",
        desc: "바울과 바나바가 1차 전도여행을 마치고 수리아 안디옥으로 배를 탄 밤빌리아의 항구입니다.",
    ...
    {id: "derbe", name: "더베", en: "Derbe", modern: "터키 케르티 회위크 일대(유력)", type: "도시",
        lngLat: [33.36, 37.35], from: -300, to: 100, importance: 3, certainty: "PROBABLE",
        desc: "1차 전도여행의 동쪽 종착지이자 2차 전도여행 때 다시 방문한 남부 갈라디아의 도시입니다.",
        refs: [{label: "사도행전 14장", bookOrder: 44, chapter: 14}, {label: "사도행전 16장", bookOrder: 44, chapter: 16}]},
    {id: "macedonia", name: "마게도냐", en: "Macedonia", modern: "그리스 북부 마케도니아 일대", type: "지역",
        lngLat: [22.40, 41.20], from: -332, to: 100, importance: 2, certainty: "CONFIRMED",
        desc: "알렉산더의 본거지였던 그리스 북부 지역으로, 바울이 '마게도냐로 건너와서 우리를 도우라'는 환상을 따라 유럽 선교를 시작한 로마 속주입니다. 빌립보·데살로니가·베뢰아가 이 지역에 속합니다.",
        refs: [{label: "사도행전 16장", bookOrder: 44, chapter: 16}, {label: "고린도후서 8장", bookOrder: 47, chapter: 8}]},
    {id: "achaia", name: "아가야", en: "Achaia", modern: "그리스 남부 아티카·펠로폰네소스 일대", type: "지역",
        lngLat: [21.90, 38.30], from: -146, to: 100, importance: 2, certainty: "CONFIRMED",
        desc: "아덴과 고린도가 속한 그리스 남부의 로마 속주로, 갈리오 총독 때 바울이 재판 자리에 섰던 곳입니다.",
        refs: [{label: "사도행전 18장", bookOrder: 44, chapter: 18}, {label: "고린도후서 9장", bookOrder: 47, chapter: 9}]},
    ...
    {id: "samothrace", name: "사모드라게", en: "Samothrace", modern: "그리스 사모트라키섬", type: "섬",
        lngLat: [25.53, 40.47], from: -300, to: 100, importance: 3, certainty: "CONFIRMED",
        desc: "바울 일행이 드로아에서 마게도냐로 건너가며 하룻밤 머문 에게해의 섬입니다.",
        refs: [{label: "사도행전 16장", bookOrder: 44, chapter: 16}]},
    {id: "neapolis-macedonia", name: "네압볼리", en: "Neapolis", modern: "그리스 카발라", type: "항구",
        lngLat: [24.41, 40.94], from: -300, to: 100, importance: 3, certainty: "CONFIRMED",
        desc: "바울 일행이 유럽에 처음 상륙해 빌립보로 향한 마게도냐의 항구입니다.",
        refs: [{label: "사도행전 16장", bookOrder: 44, chapter: 16}]},
    ...
    {id: "amphipolis", name: "암비볼리", en: "Amphipolis", modern: "그리스 암피폴리", type: "도시",
        lngLat: [23.84, 40.82], from: -300, to: 100, importance: 3, certainty: "CONFIRMED",
        desc: "바울 일행이 빌립보에서 데살로니가로 가며 비아 에그나티아를 따라 지난 도시입니다.",
        refs: [{label: "사도행전 17장", bookOrder: 44, chapter: 17}]},
    {id: "apollonia-macedonia", name: "아볼로니아", en: "Apollonia", modern: "그리스 네아 아폴로니아 인근", type: "도시",
        lngLat: [23.49, 40.64], from: -300, to: 100, importance: 3, certainty: "PROBABLE",
        desc: "암비볼리와 데살로니가 사이 비아 에그나티아에 있던 역참 도시입니다.",
        refs: [{label: "사도행전 17장", bookOrder: 44, chapter: 17}]},
    ...
    {id: "cenchreae", name: "겐그레아", en: "Cenchreae", modern: "그리스 케크리에스", type: "항구",
        lngLat: [22.99, 37.88], from: -300, to: 100, importance: 3, certainty: "CONFIRMED",
        desc: "고린도의 동쪽 외항으로, 바울이 2차 전도여행 귀환길에 배를 탄 곳입니다.",
        refs: [{label: "사도행전 18장", bookOrder: 44, chapter: 18}, {label: "로마서 16장", bookOrder: 45, chapter: 16}]},
    ...
    {id: "assos", name: "앗소", en: "Assos", modern: "터키 베흐람칼레", type: "항구",
        lngLat: [26.34, 39.49], from: -300, to: 100, importance: 3, certainty: "CONFIRMED",
        desc: "바울이 드로아에서 육로로 이동해 동행자들의 배에 합류한 항구입니다.",
        refs: [{label: "사도행전 20장", bookOrder: 44, chapter: 20}]},
    {id: "mytilene", name: "미둘레네", en: "Mytilene", modern: "그리스 레스보스섬 미틸리니", type: "항구",
        lngLat: [26.56, 39.10], from: -300, to: 100, importance: 3, certainty: "CONFIRMED",
        desc: "바울 일행이 3차 전도여행 귀환 항해 중 정박한 레스보스섬의 항구입니다.",
        refs: [{label: "사도행전 20장", bookOrder: 44, chapter: 20}]},
    {id: "chios", name: "기오", en: "Chios", modern: "그리스 히오스섬", type: "섬",
        lngLat: [26.14, 38.37], from: -300, to: 100, importance: 3, certainty: "CONFIRMED",
        desc: "미둘레네 다음 날 바울 일행이 맞은편 해역에 이른 에게해의 섬입니다.",
        refs: [{label: "사도행전 20장", bookOrder: 44, chapter: 20}]},
    {id: "samos", name: "사모", en: "Samos", modern: "그리스 사모스섬", type: "섬",
        lngLat: [26.94, 37.69], from: -300, to: 100, importance: 3, certainty: "CONFIRMED",
        desc: "바울 일행이 밀레도로 향하며 들른 에게해의 섬입니다.",
        refs: [{label: "사도행전 20장", bookOrder: 44, chapter: 20}]},
    {id: "cos", name: "고스", en: "Cos", modern: "그리스 코스섬", type: "섬",
        lngLat: [27.29, 36.89], from: -300, to: 100, importance: 3, certainty: "CONFIRMED",
        desc: "밀레도를 떠난 바울 일행이 예루살렘으로 향하며 처음 도착한 섬입니다.",
        refs: [{label: "사도행전 21장", bookOrder: 44, chapter: 21}]},
    {id: "rhodes", name: "로도", en: "Rhodes", modern: "그리스 로도스섬", type: "섬",
        lngLat: [28.23, 36.44], from: -300, to: 100, importance: 3, certainty: "CONFIRMED",
        desc: "고스 다음으로 바울 일행이 들른 동부 지중해의 섬입니다.",
        refs: [{label: "사도행전 21장", bookOrder: 44, chapter: 21}]},
    {id: "patara", name: "바다라", en: "Patara", modern: "터키 게레미시 인근", type: "항구",
        lngLat: [29.32, 36.26], from: -300, to: 100, importance: 3, certainty: "CONFIRMED",
        desc: "바울 일행이 베니게로 가는 배로 갈아탄 루기아의 항구입니다.",
        refs: [{label: "사도행전 21장", bookOrder: 44, chapter: 21}]},
    {id: "ptolemais", name: "돌레마이", en: "Ptolemais", modern: "이스라엘 아코", type: "항구",
        lngLat: [35.08, 32.92], from: -300, to: 100, importance: 3, certainty: "CONFIRMED",
        desc: "두로를 떠난 바울 일행이 형제들과 하루 머문 항구 도시입니다.",
        refs: [{label: "사도행전 21장", bookOrder: 44, chapter: 21}]},
    {id: "myra", name: "무라", en: "Myra", modern: "터키 데므레", type: "항구",
        lngLat: [30.00, 36.26], from: -300, to: 100, importance: 3, certainty: "CONFIRMED",
        desc: "로마로 이송되던 바울이 알렉산드리아 배로 갈아탄 루기아의 항구입니다.",
        refs: [{label: "사도행전 27장", bookOrder: 44, chapter: 27}]},
    {id: "cnidus", name: "니도", en: "Cnidus", modern: "터키 닷차반도 테키르", type: "항구",
        lngLat: [27.37, 36.69], from: -300, to: 100, importance: 3, certainty: "CONFIRMED",
        desc: "맞바람으로 항해가 지연된 바울의 배가 간신히 도달한 소아시아 남서단의 항구입니다.",
        refs: [{label: "사도행전 27장", bookOrder: 44, chapter: 27}]},
    {id: "fair-havens", name: "미항", en: "Fair Havens", modern: "그리스 크레타섬 칼리 리메네스", type: "항구",
        lngLat: [24.73, 34.93], from: -300, to: 100, importance: 3, certainty: "CONFIRMED",
        desc: "바울이 겨울을 나자고 권했으나 선원들이 뵈닉스로 출항한 크레타 남안의 항구입니다.",
        refs: [{label: "사도행전 27장", bookOrder: 44, chapter: 27}]},
    ...
    {id: "syracuse", name: "수라구사", en: "Syracuse", modern: "이탈리아 시라쿠사", type: "항구",
        lngLat: [15.28, 37.07], from: -300, to: 100, importance: 3, certainty: "CONFIRMED",
        desc: "멜리데를 떠난 바울 일행이 사흘 동안 머문 시칠리아의 항구입니다.",
        refs: [{label: "사도행전 28장", bookOrder: 44, chapter: 28}]},
    {id: "rhegium", name: "레기온", en: "Rhegium", modern: "이탈리아 레조디칼라브리아", type: "항구",
        lngLat: [15.65, 38.11], from: -300, to: 100, importance: 3, certainty: "CONFIRMED",
        desc: "수라구사 다음으로 바울 일행이 도착한 이탈리아 남단의 항구입니다.",
        refs: [{label: "사도행전 28장", bookOrder: 44, chapter: 28}]},
    {id: "puteoli", name: "보디올", en: "Puteoli", modern: "이탈리아 포추올리", type: "항구",
        ...
        refs: [{label: "사도행전 28장", bookOrder: 44, chapter: 28}]},
    {id: "forum-appii", name: "압비오 광장", en: "Forum Appii", modern: "이탈리아 보르고 파이티 인근", type: "역참",
        lngLat: [12.98, 41.47], from: -300, to: 100, importance: 3, certainty: "PROBABLE",
        desc: "로마의 성도들이 바울을 맞으러 내려온 아피아 가도의 역참입니다.",
        refs: [{label: "사도행전 28장", bookOrder: 44, chapter: 28}]},
    {id: "three-taverns", name: "삼관", en: "Tres Tabernae", modern: "이탈리아 치스테르나디라티나 인근", type: "역참",
        lngLat: [12.79, 41.56], from: -300, to: 100, importance: 3, certainty: "PROBABLE",
        desc: "압비오 광장과 함께 로마 성도들이 바울을 영접한 아피아 가도의 역참입니다.",
        refs: [{label: "사도행전 28장", bookOrder: 44, chapter: 28}]},
    ...
    {id: "patmos", name: "밧모", en: "Patmos", modern: "그리스 파트모스섬", type: "섬",
        lngLat: [26.55, 37.31], from: -300, to: 100, importance: 3, certainty: "CONFIRMED",
        desc: "요한계시록에서 요한이 유배 중 환상을 본 것으로 기록된 에게해의 섬입니다.",
        refs: [{label: "요한계시록 1장", bookOrder: 66, chapter: 1}]},
...
const POLITIES = {
    ...
    "s-exile": [
        ...
        {name: "리디아", center: [29.7, 38.9], radiusKm: 360, color: "#0d9488"},
        {name: "애굽", center: [31.3, 29.9], radiusKm: 320, color: "#d97706"}
    ],
    "s-persia-cyrus": [
    ...
    "s-rome-pompey": [
        {name: "로마 공화정 영향권", center: [18.0, 38.5], radiusKm: 1850, color: "#dc2626"},
        {name: "하스몬 유대 (로마 종속)", center: [35.2, 31.8], radiusKm: 100, color: "#2563eb"},
        {name: "프톨레마이오스 애굽", center: [31.0, 28.5], radiusKm: 600, color: "#d97706"},
        {name: "나바테아 왕국", center: [35.5, 30.0], radiusKm: 260, color: "#059669"},
        {name: "파르티아 제국", center: [50.0, 34.0], radiusKm: 900, color: "#78716c"}
    ],
    "s-rome-herod": [
        {name: "로마 지배권", center: [18.0, 38.5], radiusKm: 2100, color: "#dc2626"},
        {name: "헤롯 왕국·후계 분봉왕국", center: [35.2, 31.9], radiusKm: 150, color: "#2563eb"},
        {name: "나바테아 왕국", center: [35.5, 30.0], radiusKm: 260, color: "#059669"},
        {name: "파르티아 제국", center: [50.0, 34.0], radiusKm: 900, color: "#78716c"}
    ],
    "s-rome-herod": [
        {name: "로마 제국", center: [18.0, 38.5], radiusKm: 2100, color: "#dc2626"},
        {name: "헤롯 왕국 (유대·갈릴리·이두매)", center: [35.3, 31.9], radiusKm: 150, color: "#2563eb"},
        {name: "나바테아 왕국", center: [35.5, 30.0], radiusKm: 260, color: "#d97706"},
        {name: "파르티아 제국", center: [50.0, 34.0], radiusKm: 900, color: "#78716c"}
    ],
    "s-rome-nt": [
        {name: "로마 제국", center: [18.0, 38.5], radiusKm: 2100, color: "#dc2626"},
        {name: "유대 속주", center: [35.2, 31.65], radiusKm: 90, color: "#2563eb"},
        {name: "갈릴리·베레아(요단 동편) 분봉왕국", center: [35.55, 32.45], radiusKm: 105, color: "#059669"},
        {name: "빌립의 북동부 분봉왕국", center: [35.85, 33.0], radiusKm: 95, color: "#8b5cf6"},
        {name: "나바테아 왕국", center: [35.5, 30.0], radiusKm: 260, color: "#d97706"},
        {name: "파르티아 제국", center: [50.0, 34.0], radiusKm: 900, color: "#78716c"}
    ],
    "s-rome-agrippa": [
        {name: "로마 제국", center: [18.0, 38.5], radiusKm: 2100, color: "#dc2626"},
        {name: "헤롯 아그립바 1세 왕국", center: [35.3, 32.0], radiusKm: 155, color: "#2563eb"},
        {name: "나바테아 왕국", center: [35.5, 30.0], radiusKm: 260, color: "#059669"},
        {name: "파르티아 제국", center: [50.0, 34.0], radiusKm: 900, color: "#78716c"}
    ],
    "s-apostolic": [
        {name: "로마 제국", center: [18.0, 38.5], radiusKm: 2100, color: "#dc2626"},
        {name: "유대·갈릴리 (로마 영향권)", center: [35.3, 32.0], radiusKm: 150, color: "#2563eb"},
        {name: "나바테아 왕국", center: [35.5, 30.0], radiusKm: 260, color: "#059669"},
        {name: "파르티아 제국", center: [50.0, 34.0], radiusKm: 900, color: "#78716c"}
    ],
    "s-apostolic-missions": [
        {name: "로마 제국", center: [18.0, 38.5], radiusKm: 2100, color: "#dc2626"},
        {name: "유대 속주", center: [35.25, 31.9], radiusKm: 145, color: "#2563eb"},
        {name: "나바테아 왕국", center: [35.5, 30.0], radiusKm: 260, color: "#059669"},
        {name: "파르티아 제국", center: [50.0, 34.0], radiusKm: 900, color: "#78716c"}
    ],
    "s-apostolic-late": [
        {name: "로마 제국", center: [18.0, 38.5], radiusKm: 2100, color: "#dc2626"},
        {name: "전쟁 이후 유대 속주", center: [35.25, 31.9], radiusKm: 145, color: "#2563eb"},
        {name: "나바테아 왕국", center: [35.5, 30.0], radiusKm: 260, color: "#059669"},
        {name: "파르티아 제국", center: [50.0, 34.0], radiusKm: 900, color: "#78716c"}
    ]
};
...
/* ---------- 사건 (§15.7) ---------- */
const EVENTS = [
    {id: "ev-exodus", title: "출애굽 (애굽 탈출)", year: -1270, placeId: "rameses", certainty: "DISPUTED",
        desc: "이스라엘 백성이 애굽에서 나왔습니다. 연대는 열왕기상 6:1을 근거로 한 15세기설(BC 1446년경)과 라암셋 건축을 근거로 한 13세기설(BC 1270년경)로 나뉘며, 지도 연표는 13세기설을 기준으로 배치했습니다.",
        refs: [{label: "출애굽기 12장", bookOrder: 2, chapter: 12}, {label: "출애굽기 14장", bookOrder: 2, chapter: 14}]},
    {id: "ev-red-sea", title: "홍해 도하", year: -1270, placeId: "pi-hahiroth", certainty: "DISPUTED",
        desc: "비하히롯 앞에서 바다가 갈라져 이스라엘이 마른 땅으로 건너고 애굽 군대는 수장되었습니다. 도하 지점은 견해가 갈립니다.",
        refs: [{label: "출애굽기 14장", bookOrder: 2, chapter: 14}]},
    {id: "ev-amalek", title: "르비딤 전투 (아말렉)", year: -1270, placeId: "rephidim", certainty: "DISPUTED",
        desc: "모세가 손을 드는 동안 여호수아가 아말렉과 싸워 이겼고, 반석에서 물이 나왔습니다.",
        refs: [{label: "출애굽기 17장", bookOrder: 2, chapter: 17}]},
    {id: "ev-sinai-covenant", title: "시내산 언약과 십계명", year: -1269, placeId: "sinai", certainty: "DISPUTED",
    ...
    {id: "ev-kadesh-spies", title: "가데스 바네아 정탐과 광야 유랑", year: -1268, placeId: "kadesh", certainty: "DISPUTED",
        desc: "열두 정탐꾼의 보고 후 백성이 믿지 않으므로, 그 세대가 다 죽기까지 40년을 광야에서 지내게 되었습니다.",
        refs: [{label: "민수기 13장", bookOrder: 4, chapter: 13}, {label: "민수기 14장", bookOrder: 4, chapter: 14}]},
    {id: "ev-sihon-og", title: "시혼과 옥 격파 (요단 동편 정복)", year: -1231, placeId: "heshbon", certainty: "DISPUTED",
        desc: "이스라엘이 헤스본 왕 시혼과 바산 왕 옥을 이기고 요단 동편 땅을 차지했습니다.",
        refs: [{label: "민수기 21장", bookOrder: 4, chapter: 21}]},
    {id: "ev-jordan-jericho", title: "요단 도하와 여리고 함락", year: -1230, placeId: "jericho", certainty: "DISPUTED",
    ...
    {id: "ev-daniel-deport", title: "1차 포로 이주 (다니엘)", year: -605, placeId: "jerusalem", certainty: "PROBABLE",
        desc: "갈그미스 전투 후 느부갓네살이 예루살렘에 이르러 다니엘을 포함한 왕족·귀족 소년들과 성전 기물 일부를 바벨론으로 가져갔습니다.",
        refs: [{label: "다니엘 1장", bookOrder: 27, chapter: 1}]},
    {id: "ev-first-deport", title: "2차 포로 이주 (여호야긴)", year: -597, placeId: "jerusalem", certainty: "CONFIRMED",
        desc: "여호야긴 왕과 지도층 만여 명이 바벨론으로 사로잡혀 갔으며, 에스겔도 이때 끌려갔습니다.",
        refs: [{label: "열왕기하 24장", bookOrder: 12, chapter: 24}, {label: "에스겔 1장", bookOrder: 26, chapter: 1}]},
    {id: "ev-ezekiel-call", title: "그발 강가에서 에스겔의 소명", year: -593, placeId: "tel-abib", certainty: "APPROXIMATE",
        desc: "여호야긴이 사로잡힌 지 5년째에 에스겔이 갈대아 땅 그발 강가에서 하나님의 이상을 보고 선지자로 부름받았습니다.",
        refs: [{label: "에스겔 1장", bookOrder: 26, chapter: 1}, {label: "에스겔 3장", bookOrder: 26, chapter: 3}]},
    {id: "ev-jerusalem-fall", title: "예루살렘 함락과 성전 파괴", year: -586, placeId: "jerusalem", certainty: "CONFIRMED",
        desc: "느부갓네살이 예루살렘과 성전을 무너뜨리고 남유다가 멸망했습니다(3차 포로 이주). 시드기야는 하맛 땅 립나에서 심문받았습니다.",
        refs: [{label: "열왕기하 25장", bookOrder: 12, chapter: 25}, {label: "예레미야 39장", bookOrder: 24, chapter: 39}]},
    {id: "ev-gedaliah", title: "그달리야 총독 피살과 애굽 피난", year: -586, placeId: "mizpah", certainty: "APPROXIMATE",
        desc: "바벨론이 세운 총독 그달리야가 미스바에서 살해되자, 남은 백성이 예레미야를 데리고 애굽 다바네스로 내려갔습니다. 시점은 함락 직후 또는 BC 582년경으로 봅니다.",
        refs: [{label: "열왕기하 25장", bookOrder: 12, chapter: 25}, {label: "예레미야 43장", bookOrder: 24, chapter: 43}]},
    {id: "ev-jehoiachin-release", title: "여호야긴의 석방", year: -561, placeId: "babylon", certainty: "CONFIRMED",
        desc: "사로잡힌 지 37년째에 바벨론 왕 에윌므로닥이 여호야긴을 옥에서 내어놓아 왕의 상에서 먹게 했습니다. 포로기 말에 기록된 회복의 표징입니다.",
        refs: [{label: "열왕기하 25장", bookOrder: 12, chapter: 25}, {label: "예레미야 52장", bookOrder: 24, chapter: 52}]},
    {id: "ev-babylon-fall", title: "바벨론 함락", year: -539, placeId: "babylon", certainty: "CONFIRMED",
        desc: "벨사살의 잔치가 있던 밤에 바벨론이 메대·페르시아 연합에 함락되었습니다. 고레스의 바벨론 입성은 고레스 원통 비문으로도 확인됩니다.",
        refs: [{label: "다니엘 5장", bookOrder: 27, chapter: 5}]},
    ...
    {id: "ev-pompey-jerusalem", title: "폼페이우스의 예루살렘 점령", year: -63, placeId: "jerusalem", certainty: "CONFIRMED",
        desc: "로마 장군 폼페이우스가 예루살렘을 점령하면서 유대가 로마의 영향권에 들어갔습니다.",
        refs: []},
    {id: "ev-herod-king", title: "헤롯의 예루살렘 장악", year: -37, placeId: "jerusalem", certainty: "CONFIRMED",
        desc: "로마의 지원을 받은 헤롯이 예루살렘을 장악하고 유대의 왕으로 통치하기 시작했습니다.",
        refs: []},
    ...
    {id: "ev-judea-province", title: "유대의 로마 속주 편입", year: 6, placeId: "caesarea-maritima", certainty: "CONFIRMED",
        desc: "아켈라오가 폐위된 뒤 유대·사마리아·이두매가 로마 총독이 다스리는 유대 속주에 편입되었습니다.",
        refs: []},
    {id: "ev-jesus-ministry", title: "예수님의 갈릴리 사역 시작", year: 27, placeId: "capernaum", certainty: "APPROXIMATE",
        desc: "예수님이 세례를 받으신 뒤 갈릴리에서 하나님 나라를 선포하고 제자들을 부르기 시작하셨습니다.",
        refs: [{label: "마가복음 1장", bookOrder: 41, chapter: 1}, {label: "누가복음 3장", bookOrder: 42, chapter: 3}]},
    ...
    {id: "ev-ascension", title: "예수님의 승천", year: 30, placeId: "bethany", certainty: "APPROXIMATE",
        desc: "부활하신 예수님이 제자들을 베다니 앞까지 데리고 나가 축복하시고 하늘로 올라가셨습니다.",
        refs: [{label: "누가복음 24장", bookOrder: 42, chapter: 24}, {label: "사도행전 1장", bookOrder: 44, chapter: 1}]},
    ...
    {id: "ev-stephen", title: "스데반 순교와 교회 분산", year: 34, placeId: "jerusalem", certainty: "APPROXIMATE",
        desc: "스데반의 순교 뒤 박해가 일어나 예루살렘 교회 신자들이 유대와 사마리아 여러 지역으로 흩어졌습니다.",
        refs: [{label: "사도행전 7장", bookOrder: 44, chapter: 7}, {label: "사도행전 8장", bookOrder: 44, chapter: 8}]},
    {id: "ev-philip-ethiopian", title: "빌립과 에디오피아 내시", year: 34, placeId: "gaza", certainty: "APPROXIMATE",
        desc: "빌립이 예루살렘에서 가사로 내려가는 길에서 에디오피아 여왕 간다게의 내시에게 복음을 전하고 세례를 주었습니다.",
        refs: [{label: "사도행전 8장", bookOrder: 44, chapter: 8}]},
    {id: "ev-paul-conversion", title: "사울의 회심", year: 35, placeId: "damascus", certainty: "APPROXIMATE",
        desc: "교회를 박해하던 사울이 다메섹으로 가는 길에서 예수님을 만난 뒤 복음을 전하는 사람이 되었습니다.",
        refs: [{label: "사도행전 9장", bookOrder: 44, chapter: 9}]},
    {id: "ev-cornelius", title: "고넬료 가정에 복음 전파", year: 40, placeId: "caesarea-maritima", certainty: "APPROXIMATE",
        desc: "베드로가 로마 백부장 고넬료의 집에서 복음을 전하며 이방인 선교의 중요한 전환점이 마련되었습니다.",
        refs: [{label: "사도행전 10장", bookOrder: 44, chapter: 10}]},
    {id: "ev-antioch-church", title: "안디옥 교회와 '그리스도인' 명칭", year: 43, placeId: "antioch-syria", certainty: "APPROXIMATE",
        desc: "안디옥에서 유대인과 이방인이 함께하는 교회가 성장했고 제자들이 처음 그리스도인이라 불렸습니다.",
        refs: [{label: "사도행전 11장", bookOrder: 44, chapter: 11}]},
    {id: "ev-paul-first-journey", title: "바울 1차 전도여행 출발", year: 46, placeId: "antioch-syria", certainty: "APPROXIMATE",
        desc: "안디옥 교회가 바나바와 바울을 파송하여 구브로와 남부 갈라디아에 복음을 전하게 했습니다.",
        refs: [{label: "사도행전 13장", bookOrder: 44, chapter: 13}, {label: "사도행전 14장", bookOrder: 44, chapter: 14}]},
    {id: "ev-agrippa-persecution", title: "야고보 순교와 아그립바 1세의 죽음", year: 44, placeId: "jerusalem", certainty: "CONFIRMED",
        desc: "헤롯 아그립바 1세가 사도 야고보를 처형하고 베드로를 가두었으며, 같은 해 가이사랴에서 급사했습니다.",
        refs: [{label: "사도행전 12장", bookOrder: 44, chapter: 12}]},
    ...
    {id: "ev-paul-second-journey", title: "바울 2차 전도여행 출발", year: 49, placeId: "antioch-syria", certainty: "APPROXIMATE",
        desc: "바울과 실라가 소아시아를 지나 마게도냐와 아가야까지 복음을 전했습니다.",
        refs: [{label: "사도행전 15장", bookOrder: 44, chapter: 15}, {label: "사도행전 18장", bookOrder: 44, chapter: 18}]},
    {id: "ev-paul-third-journey", title: "바울 3차 전도여행 출발", year: 53, placeId: "antioch-syria", certainty: "APPROXIMATE",
        desc: "바울이 갈라디아와 브루기아를 거쳐 에베소에서 장기간 사역하고 다시 마게도냐와 아가야를 방문했습니다.",
        refs: [{label: "사도행전 18장", bookOrder: 44, chapter: 18}, {label: "사도행전 19장", bookOrder: 44, chapter: 19}]},
    {id: "ev-paul-rome", title: "바울의 로마 도착", year: 60, placeId: "rome", certainty: "APPROXIMATE",
        desc: "바울이 죄수의 몸으로 로마에 도착하여 복음을 전했습니다.",
        refs: [{label: "사도행전 28장", bookOrder: 44, chapter: 28}]},
    {id: "ev-nero-persecution", title: "로마 화재 이후 기독교인 박해", year: 64, placeId: "rome", certainty: "CONFIRMED",
        desc: "로마 대화재 이후 네로 황제 치하에서 로마의 기독교인들이 박해를 받았습니다.",
        refs: []},
    {id: "ev-jewish-war", title: "1차 유대 전쟁 발발", year: 66, placeId: "jerusalem", certainty: "CONFIRMED",
        desc: "유대 지역에서 로마 통치에 대한 대규모 반란이 일어나 전쟁으로 확대되었습니다.",
        refs: []},
    {id: "ev-temple-destruction", title: "예루살렘 함락과 제2성전 파괴", year: 70, placeId: "jerusalem", certainty: "CONFIRMED",
        desc: "티투스가 이끄는 로마군이 예루살렘을 함락하고 제2성전을 파괴했습니다.",
        refs: [{label: "누가복음 21장", bookOrder: 42, chapter: 21}]},
    {id: "ev-john-patmos", title: "요한의 밧모섬 환상", year: 95, placeId: "patmos", certainty: "DISPUTED",
        desc: "요한계시록은 요한이 밧모섬에서 환상을 보았다고 전합니다. 기록 연대는 도미티아누스 시대 말기설과 더 이른 연대설로 나뉩니다.",
        refs: [{label: "요한계시록 1장", bookOrder: 66, chapter: 1}]}
];
...
function routeCoordinates(...stops) {
    return stops.map(stop => {
        ...
        const place = PLACES.find(item => item.id === stop);
        if (!place) throw new Error(`Unknown route place: ${stop}`);
        return place.lngLat;
    });
}
...
const ROUTES = [
    {id: "route-exodus-south", routeGroupId: "exodus", viewpoint: "남부 경로 (전통)", name: "출애굽 경로",
        jumpYear: -1270, certainty: "DISPUTED", color: "#059669",
        desc: "라암셋과 숙곳을 떠나 비하히롯에서 바다를 건너고 마라·엘림을 지나 시내 반도 남부의 시내산(전통)에 이른 뒤 가데스 바네아로 올라갑니다. 에돔의 통과 거부로 호르 산에서 홍해 길(에시온게벨)로 돌아 에돔·모압 동편을 우회하여 모압 평지(느보산)에 이르는 전통적 견해입니다. 세부 경유지는 단순화된 근사입니다.",
        coords: [[31.83, 30.80], [32.10, 30.55], [32.55, 29.95], [33.00, 29.25], [33.10, 29.13], [33.85, 28.72], [33.97, 28.54], [34.20, 29.60], [34.42, 30.65], [35.41, 30.32], [34.98, 29.55], [35.60, 30.10], [35.95, 30.85], [36.05, 31.35], [35.81, 31.80], [35.73, 31.77], [35.44, 31.87]],
    ...
    {id: "route-exodus-north", routeGroupId: "exodus", viewpoint: "북부 경로설", name: "출애굽 경로",
        jumpYear: -1270, certainty: "DISPUTED", color: "#059669",
        desc: "시내 반도 북부를 지나는 견해로, 시내산 위치도 북부 또는 미디안 쪽으로 봅니다. 요단 동편에서는 에돔·모압을 동쪽으로 우회합니다. 세부 경유지는 단순화된 근사입니다.",
        coords: [[31.83, 30.80], [32.60, 30.75], [33.40, 30.85], [34.00, 30.60], [34.42, 30.65], [34.98, 29.55], [35.60, 30.10], [35.95, 30.85], [36.05, 31.35], [35.81, 31.80], [35.73, 31.77], [35.44, 31.87]],
    ...
    {id: "route-exile", routeGroupId: "exile-route", viewpoint: "", name: "바벨론 포로 이동",
        ...
        refs: [{label: "열왕기하 25장", bookOrder: 12, chapter: 25}, {label: "예레미야 39장", bookOrder: 24, chapter: 39}]},
    {id: "route-egypt-flight", routeGroupId: "egypt-flight", viewpoint: "", name: "애굽 피난 (예레미야 일행)",
        jumpYear: -586, certainty: "APPROXIMATE", color: "#8b5cf6",
        desc: "그달리야 피살 후 요하난과 남은 백성이 예레미야를 데리고 미스바에서 애굽 다바네스로 내려간 길을 해안 육로를 따라 근사했습니다.",
        coords: [[35.22, 31.89], [35.23, 31.78], [34.75, 31.53], [34.35, 31.35], [33.60, 31.10], [32.90, 31.02], [32.17, 30.86]],
        refs: [{label: "예레미야 41장", bookOrder: 24, chapter: 41}, {label: "예레미야 43장", bookOrder: 24, chapter: 43}]},
    ...
    {id: "route-paul-1", routeGroupId: "paul-1", viewpoint: "", name: "바울 1차 전도여행",
        jumpYear: 46, certainty: "APPROXIMATE", color: "#2563eb",
        desc: "바울과 바나바가 AD 46~48년경 수리아 안디옥에서 실루기아를 거쳐 구브로로 건너가고, 버가에서 남부 갈라디아 도시들을 순회한 뒤 같은 길로 돌아와 앗달리아에서 귀항한 여정입니다.",
        coords: routeCoordinates("antioch-syria", "seleucia-pieria", "salamis", "paphos", "perga",
            "pisidian-antioch", "iconium", "lystra", "derbe", "lystra", "iconium",
            "pisidian-antioch", "perga", "attalia", "seleucia-pieria", "antioch-syria"),
        refs: [{label: "사도행전 13장", bookOrder: 44, chapter: 13}, {label: "사도행전 14장", bookOrder: 44, chapter: 14}]},
    {id: "route-paul-2", routeGroupId: "paul-2", viewpoint: "", name: "바울 2차 전도여행",
        jumpYear: 49, certainty: "APPROXIMATE", color: "#7c3aed",
        desc: "AD 49~52년경 수리아와 길리기아에서 남부 갈라디아를 지나 드로아로 간 뒤, 사모드라게와 네압볼리를 거쳐 마게도냐와 아가야에 복음을 전하고 겐그레아·에베소·가이사랴를 거쳐 돌아온 여정입니다.",
        coords: routeCoordinates("antioch-syria", "tarsus", "derbe", "lystra", "iconium",
            "pisidian-antioch", "troas", "samothrace", "neapolis-macedonia", "philippi",
            "amphipolis", "apollonia-macedonia", "thessalonica", "berea", "athens", "corinth",
            "cenchreae", "ephesus", "caesarea-maritima", "jerusalem", "antioch-syria"),
    ...
    {id: "route-paul-3", routeGroupId: "paul-3", viewpoint: "", name: "바울 3차 전도여행",
        jumpYear: 53, certainty: "APPROXIMATE", color: "#db2777",
        desc: "AD 53~57년경 갈라디아와 브루기아를 거쳐 에베소에서 장기간 사역하고 마게도냐와 고린도를 방문한 뒤, 드로아·앗소·미둘레네·기오·사모·밀레도와 동부 지중해 항구들을 거쳐 예루살렘으로 돌아온 여정입니다.",
        coords: routeCoordinates("antioch-syria", "tarsus", "derbe", "lystra", "iconium",
            "pisidian-antioch", "ephesus", "troas", "philippi", "thessalonica", "berea", "corinth",
            "philippi", "troas", "assos", "mytilene", "chios", "samos", "miletus", "cos",
            "rhodes", "patara", "tyre", "ptolemais", "caesarea-maritima", "jerusalem"),
        refs: [{label: "사도행전 19장", bookOrder: 44, chapter: 19}, {label: "사도행전 20장", bookOrder: 44, chapter: 20}, {label: "사도행전 21장", bookOrder: 44, chapter: 21}]},
    {id: "route-paul-rome", routeGroupId: "paul-rome", viewpoint: "", name: "바울의 로마 이송",
        jumpYear: 59, certainty: "APPROXIMATE", color: "#d97706",
        desc: "AD 59~60년경 가이사랴에서 시돈·무라·니도를 거쳐 크레타 미항에 이르고, 폭풍으로 표류해 멜리데에 상륙한 뒤 수라구사·레기온·보디올과 아피아 가도를 지나 로마에 도착한 여정입니다.",
        coords: routeCoordinates("caesarea-maritima", "sidon", [33.2, 35.7], "myra", "cnidus",
            "fair-havens", [23.2, 34.7], [21.0, 34.4], [18.0, 34.8], "malta", "syracuse",
            "rhegium", "puteoli", "forum-appii", "three-taverns", "rome"),
