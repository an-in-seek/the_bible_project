...
const HOLY_WEEK_EVENTS = [
    ...
    },
    {
        ...
        title: "성전 정화",
        emoji: "\uD83C\uDFDB\uFE0F",
        description: "예수님이 예루살렘 성전에 들어가 매매하는 자들을 내쫓으시고 돈 바꾸는 자들의 상을 뒤엎으셨습니다. '내 집은 기도하는 집이라 일컬음을 받으리라 하였거늘 너희는 강도의 소굴을 만드는도다'라고 말씀하셨습니다. 이는 성전이 본래의 목적인 하나님과의 교제의 장소로 회복되어야 함을 선포하신 것입니다. 성으로 오시던 길에는 잎만 무성하고 열매 없는 무화과나무를 저주하셨는데(마가복음 11:12-14), 이는 겉모습뿐인 신앙에 대한 경고였습니다.",
        verse: "마태복음 21:12-17",
    ...
    },
    {
        ...
        title: "예수님의 죽음",
        emoji: "\uD83D\uDD4A\uFE0F",
        description: "제6시(정오)부터 제9시(오후 3시)까지 온 땅에 어둠이 임했습니다. 제9시에 예수님이 '엘리 엘리 라마 사박다니'(마태복음) 곧 '엘로이 엘로이 라마 사박다니'(마가복음, 나의 하나님 나의 하나님 어찌하여 나를 버리셨나이까)라고 크게 소리치셨고, '다 이루었다'(요한복음 19:30)고 말씀하신 후 숨을 거두셨습니다. 이때 성전 휘장이 위에서 아래로 둘로 찢어지고, 땅이 진동하며 바위가 터졌습니다.",
        verse: "마가복음 15:33-39",
    ...
    },
    {
        ...
        title: "부활",
        emoji: "\u2728",
        description: "안식일이 지난 첫날 새벽, 여인들이 향료를 가지고 무덤을 찾았을 때 돌이 이미 굴려져 있었고, 천사가 '그가 여기 계시지 않고 그가 말씀하시던 대로 살아나셨다'고 전했습니다. 부활은 기독교 신앙의 핵심이며, 예수님이 죄와 죽음을 이기신 결정적 사건입니다. 바울은 '그리스도께서 다시 살아나지 못하셨으면 너희의 믿음도 헛되다'(고린도전서 15:17)고 선언합니다. 유대 절기로는 첫 이삭을 흔들어 드리는 초실절(레위기 23:10-11)에 해당하여, 바울은 예수님을 '잠자는 자들의 첫 열매'(고린도전서 15:20)라 부릅니다.",
        verse: "마태복음 28:1-6",
