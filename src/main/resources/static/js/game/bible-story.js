    ...
    beats: [
      {
        ...
        lines: [
          ...
          {text: '그 한마디 뒤로 재앙이 시작됐다. 나일강이 피로 변했고, 개구리와 이와 파리 떼가 온 땅을 뒤덮었다.', ref: '출애굽기 7–8장'},
          {text: '가축이 쓰러지고 사람 몸에 악성 종기가 퍼졌다. 우박이 곡식을 때렸고, 메뚜기가 남은 이삭까지 갉아먹었다.', ref: '출애굽기 9–10장'},
          {text: '아홉 번째로 사흘 동안 짙은 어둠이 이집트를 덮었다. 그런데도 바로는 요지부동, 고집을 꺾지 않았다.', ref: '출애굽기 10:21–23'},
          {text: '이제 남은 것은 열 번째, 마지막 재앙. 이집트의 모든 장자가 죽는 밤이다.', ref: '출애굽기 11:4–5'},
          {who: '기록자', text: '나는 기록자다. 심판이 예고된 이 밤, 하나님이 자기 백성에게 미리 열어 두신 구원의 길을 기록하러 왔다.'},
          {text: '그 길은 흠 없는 어린양 한 마리였다. 해가 지기 직전, 고센 땅의 한 집이 문을 열어 나를 들여보내 주었다.', ref: '출애굽기 12:3–6'}
        ]
      },
      {
        type: 'say',
