    ...
    records: [
      {
        ...
        body: '요셉을 모르는 새 왕이 이스라엘 백성을 노예로 삼아 고된 노동을 시켰고, 그 신음이 하나님께 닿은 이야기입니다.',
        ref: '출애굽기 1–2장',
        href: '/web/bible/verse?translationId=1&bookOrder=2&chapterNumber=1'
      },
      {
        title: '아홉 번의 재앙',
        provenance: 'scripture',
        body: '바로가 이스라엘을 보내기를 거부하자 피·개구리·이·파리·가축 전염병·악성 종기·우박·메뚜기·어둠의 재앙이 차례로 이집트를 덮쳤습니다.',
        ref: '출애굽기 7–10장',
        href: '/web/bible/verse?translationId=1&bookOrder=2&chapterNumber=7'
      },
      {
        title: '유월절 어린양',
        provenance: 'scripture',
      ...
      },
      {
        title: '안나네 가족',
        provenance: 'creative',
        body: '안나와 아버지·어머니·오빠는 성경에 나오지 않는 인물입니다. 유월절 밤을 한 가정의 눈높이에서 따라가려고 만든 배역이며, 이들이 겪는 상황과 순서는 출애굽기 12장의 규정을 그대로 따릅니다.',
        ref: '출애굽기 12장',
        href: '/web/bible/verse?translationId=1&bookOrder=2&chapterNumber=12'
      }
    ],
    beats: [
      {
        ...
        lines: [
          ...
          {phase: 'labor-decree', text: '벽돌을 굽고 흙을 이기는 노동이 대를 이어 계속됐다. 나중에는 갓 태어난 사내아이를 강에 던지라는 명령까지 내려졌다.', ref: '출애굽기 1:13–22'},
          {phase: 'cries', text: '400년 넘게 쌓인 신음이 마침내 하늘에 닿았다. 하나님은 그 부르짖음을 들으시고 모세를 바로 앞에 세우셨다.', ref: '출애굽기 2:23–25'},
          {
            phase: 'moses-demands',
            who: '모세',
            word: true,
            text: '이스라엘의 하나님 여호와께서 말씀하십니다. 내 백성을 보내라. 그들이 광야에서 나를 섬길 것이다.',
            ref: '출애굽기 5:1'
          },
          {
            phase: 'pharaoh-defies',
            who: '바로',
            word: true,
            text: '여호와가 누구기에 내가 그 말을 듣고 이스라엘을 보내야 하느냐? 나는 여호와를 알지 못한다.',
            ref: '출애굽기 5:2'
          },
      ...
      },
      {
        ...
        lines: [
          ...
          {phase: 'father-welcome', who: '기록자', text: '해가 지평선에 걸릴 무렵, 나는 고센 땅의 한 집 앞에 이르렀다. 문간에는 어린양 한 마리가 매여 있었다.'}
        ]
      },
      {
        type: 'say',
        lines: [
          ...
          },
          {
            ...
            who: '기록자',
            text: '안나 아버지는 마당으로 나가서 문간에 매여 있던 어린양을 잡아 손질했고, 그 피를 받은 그릇은 이 집의 맏아들인 안나의 오빠가 두 손으로 받쳐 들고 있었다.'
          },
          {
            phase: 'firstborn-bowl',
            who: '안나 오빠',
          ...
          },
          {
            phase: 'lamb-ready',
            who: '기록자',
            text: '해가 마지막 빛을 거둘 무렵, 안나 아버지와 안나 오빠는 문 앞에 마주 섰다. 문간 평상에는 피를 담은 그릇이 놓였고, 아버지의 손에는 우슬초 한 묶음이 들려 있었다.',
            ref: '출애굽기 12:22',
          },
          {
            phase: 'lamb-ready',
            who: '안나 아버지',
            text: '아들아 양의 피는 다 받아 두었으니, 이제 하나님께서 말씀하신 대로 문에 바르자!',
            ref: '출애굽기 12:6–7'
          },
        ]
      },
    ...
    beats: [
      {
        ...
        lines: [
          ...
          {phase: 'army', text: '그 무렵 이집트에서는 바로와 신하들의 마음이 돌변했다.', ref: '출애굽기 14:5'},
          {
            who: '바로',
            word: true,
          ...
          {text: '바로는 정예 전차 600대에 이집트의 모든 전차를 총동원해 추격에 나섰다.', ref: '출애굽기 14:7'},
          {phase: 'trapped', text: '앞은 바다, 뒤는 이집트의 전차. 진퇴양난이다.'},
      ...
      },
      {
        ...
        options: [
          {value: 'back', label: '돌아갈 길을 찾는다', reply: '뒤를 돌아봤다. 전차가 일으킨 흙먼지가 이미 지평선을 뒤덮고 있었다. 퇴로는 없다.'},
          {value: 'fight', label: '싸울 준비를 한다', reply: '지팡이와 막대기뿐인 행렬로 전차와 맞선다? 계란으로 바위 치기였다.'},
      ...
      },
      {
        ...
        doneLine: {text: '뒤쫓던 전차들 위로 물이 다시 덮쳤다. 바로의 군대는 흔적도 없이 사라졌다.', ref: '출애굽기 14:27–28'}
      },
      {
        type: 'say',
        lines: [
    ...
    beats: [
      {
        ...
        lines: [
          ...
          {text: '이집트를 떠난 지 한 달째. 신 광야에서 먹을 것이 바닥나자 온 백성의 원성이 터져 나왔다.', ref: '출애굽기 16:1–2'},
...
function renderSeaCrossBeat(beat) {
  ...
  elements.storyPlayArea.innerHTML = `
        ...
        <p class="story-sea-caption" id="seaCaption" aria-live="polite">등 뒤에서 전차 소리가 밀려온다. 지금이 아니면 늦는다!</p>
  ...
  const chase = window.setInterval(() => {
    ...
    if (gap <= GAP_MIN + 1 && !warned) {
      warned = true;
      caption.textContent = '전차가 등 뒤까지 따라붙었다. 더 빨리!';
    }
  }, 260);
