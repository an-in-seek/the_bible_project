  ...
  },
  {
    ...
    beats: [
      ...
      },
      {
        ...
        wordLine: {who: '모세', word: true, text: '너희는 두려워하지 말고 가만히 서서 여호와께서 오늘 너희를 위하여 행하시는 구원을 보라.', ref: '출애굽기 14:13'},
    ...
    beats: [
      {
        ...
        lines: [
          ...
          {phase: 'risen', who: '천사', word: true, text: '어찌하여 살아 있는 자를 죽은 자 가운데서 찾느냐 여기 계시지 않고 살아나셨느니라.', ref: '누가복음 24:5–6'}
        ]
      },
      {type: 'finale'}
    ]
