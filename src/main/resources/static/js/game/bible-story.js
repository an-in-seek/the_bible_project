        ...
        beats: [
            {
                type: 'say',
                lines: [
                    {text: '기록은 여기서 오랜 세월을 건너뛴다. 네 개의 조각은 낡은 두루마리 속에서 대답을 기다려 왔다.'},
                    {who: '기록자', text: '이제 신약의 증언들을 앞에 놓는다. 이 연결은 남이 대신해 줄 수 없다. 내 손으로 이어야 한다.'}
                ]
            },
            {
                type: 'match',
        ...
        beats: [
            {
                type: 'say',
                lines: [
                    {phase: 'cross', text: '유월절 어린양을 잡는 날. 예루살렘 성문 밖, 예수께서 십자가에 달리셨다.'},
